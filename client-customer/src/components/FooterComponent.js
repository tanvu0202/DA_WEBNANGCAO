          ...
          <div className="w-full sm:w-1/2 md:w-1/4 p-4">
            ...
            <ul className='text-[14px] space-y-2'>
              <li className='hover:text-orange-600 cursor-pointer transition-colors'>
                <Link to="/login" className="block w-full">Đăng nhập / Đăng ký</Link>
              </li>
              <li className='hover:text-orange-600 cursor-pointer transition-colors'>
                Thay đổi địa chỉ
              </li>
              <li className='hover:text-orange-600 cursor-pointer transition-colors'>
                {/* Liên kết tới trang Thông tin cá nhân */}
                <Link to="/myprofile" className="block w-full">Chi tiết tài khoản</Link>
              </li>
              <li className='hover:text-orange-600 cursor-pointer transition-colors'>
                {/* Liên kết tới trang Đơn hàng */}
                <Link to="/myorders" className="block w-full">Lịch sử mua hàng</Link>
              </li>
            </ul>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/4 p-4">
